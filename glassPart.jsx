...
function GlassPart({ uniqueIdentifier }) {
  ...
  const localStorageKey = `nameGlass01_${uniqueIdentifier}`;
  const localStorageSelectKey1 = `subCategoryGlass01_${uniqueIdentifier}`;
  const localStorageSelectKey2 = `fdaComplianceGlass01_${uniqueIdentifier}`;
  const localStorageTextInputKey = `otherCategoryGlass01_${uniqueIdentifier}`;
  const localStorageTextInputKey2 = `otherFdaGlass01_${uniqueIdentifier}`;
  const localStorageTextInputKey4 = `gmpExplainGlass01_${uniqueIdentifier}`;
  const localStorageTextInputKey5= `supplierNameGlass01_${uniqueIdentifier}`;
  const localStorageRadioKey = `gmpComplianceGlass01_${uniqueIdentifier}`;
  const localStorageRadioKey2 = `fdaGrasGlass01_${uniqueIdentifier}`;
  const localStorageRadioKey3 = `regulatedGrasGlass01_${uniqueIdentifier}`;
  const localStorageResultVisible = `resultVisibleGlass01_${uniqueIdentifier}`;
 ...
 useEffect (() => {
  ...
  return (
    <><div className="fixed-header">
      <h1 className="header-title">Glass Questionnaire</h1>
