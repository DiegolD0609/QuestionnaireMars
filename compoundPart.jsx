...
function CompoundPart({ uniqueIdentifier }) {
  ...
  const localStorageResultVisible = `resultVisibleCompound01_${uniqueIdentifier}`;
  const localStorageKey = `nameCompound01_${uniqueIdentifier}`;
  const localStorageSelectKey1 = `subCategoryCompound01_${uniqueIdentifier}`;
  const localStorageSelectKey2 = `fdaComplianceCompound01_${uniqueIdentifier}`;
  const localStorageTextInputKey = `otherCategoryCompound01_${uniqueIdentifier}`;
  const localStorageTextInputKey2 = `otherFdaCompound01_${uniqueIdentifier}`;
  const localStorageTextInputKey4 = `gmpExplainCompound01_${uniqueIdentifier}`;
  const localStorageTextInputKey5= `supplierNameCompound01_${uniqueIdentifier}`;
  const localStorageRadioKey = `gmpComplianceCompound01_${uniqueIdentifier}`;
  const localStorageRadioKey2 = `fdaGrasCompound01_${uniqueIdentifier}`;
  const localStorageRadioKey3 = `regulatedGrasCompound01_${uniqueIdentifier}`;
 ...
 useEffect (() => {
  ...
  return (
    <><div className="fixed-header">
      <h1 className="header-title">Compound Questionnaire</h1>
