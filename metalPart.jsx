...
function MetalPart({ uniqueIdentifier }) {
    ...
    const localStorageKey = `nameMetal01_${uniqueIdentifier}`;
    const localStorageSelectKey1 = `subCategoryMetal01_${uniqueIdentifier}`;
    const localStorageSelectKey2 = `fdaComplianceMetal01_${uniqueIdentifier}`;
    const localStorageTextInputKey = `otherCategoryMetal01_${uniqueIdentifier}`;
    const localStorageTextInputKey2 = `otherFdaMetal01_${uniqueIdentifier}`;
    const localStorageTextInputKey4 = `gmpExplainMetal01_${uniqueIdentifier}`;
    const localStorageTextInputKey5= `supplierNameMetal01_${uniqueIdentifier}`;
    const localStorageRadioKey = `gmpComplianceMetal01_${uniqueIdentifier}`;
    const localStorageRadioKey2 = `fdaGrasMetal01_${uniqueIdentifier}`;
    const localStorageRadioKey3 = `regulatedGrasMetal01_${uniqueIdentifier}`;
    const localStorageResultVisible = `resultVisibleMetal01_${uniqueIdentifier}`;
    ...
    const localStorageItems = [
      ...
      { key: localStorageRadioKey2, setState: setRadioValue2 },
      { key: localStorageRadioKey3, setState: setRadioValue3 },
   ...
   useEffect (() => {
    ...
    const handleRestartClick = () => {
      ...
      setTextInputVisible2(false);
      setTextInputVisible3(false);
      setTextInputValue('');
      setTextInputValue2('');
      setTextInputValue3('');
      setRadioValue('');
    ...
    return (
      <><div className="fixed-header">
        <h1 className="header-title">Metal Questionnaire</h1>
          ...
          <div className="instructions">
            ...
            <label className="label">
              ...
              <select className="select" value={selectedOption1} onChange={handleSelectChange1}>
                ...
                <option value="steelTinPlate">Steel Tin Plate</option>
            ...
            <br /> <br />
            <label className='label'> Do you have a component that certified as GRAS?</label>
            ...
            <br /> <br />
            <label className='label'>Is GRAS component listed in a regulation PART 182, 184 or 186?</label>
            <div className="radio-group">
              <label className="radio-label">
                <input
                  type="radio"
