...
function Paperpart({ uniqueIdentifier }) {
    ...
    const localStorageKey = `namePaper01_${uniqueIdentifier}`;
    const localStorageSelectKey1 = `subCategoryPaper01_${uniqueIdentifier}`;
    const localStorageSelectKey2 = `fdaCompliancePaper01_${uniqueIdentifier}`;
    const localStorageTextInputKey = `otherCategoryPaper01_${uniqueIdentifier}`;
    const localStorageTextInputKey2 = `otherFdaPaper01_${uniqueIdentifier}`;
    const localStorageTextInputKey4 = `gmpExplainPaper01_${uniqueIdentifier}`;
    const localStorageTextInputKey5= `supplierNamePaper01_${uniqueIdentifier}`;
    const localStorageRadioKey = `gmpCompliancePaper01_${uniqueIdentifier}`;
    const localStorageResultVisible = `resultVisiblePaper01_${uniqueIdentifier}`;
   ...
   useEffect (() => {
    ...
    return (
      <><div className="fixed-header">
        <h1 className="header-title">Paper Questionnaire</h1>
          ...
          <div className="instructions">
            ...
            <label className="label">
              ...
              <select className="select" value={selectedOption1} onChange={handleSelectChange1}>
                ...
                <option value="Virgin">Ceramics</option>
