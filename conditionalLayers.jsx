...
function ComponentSwitcher() {
  ...
  useEffect(() => {
    ...
    const firstValue = localStorageValues[0];
  ...
  return (
    <div>
      {currentComponent === 'first' && (
        <TextInputComponent uniqueIdentifier="1" /> // Pass the unique identifier here
      )}
      {currentComponent === 'second' && (
        <CoatingPart uniqueIdentifier="1" /> // Pass the unique identifier here
      )}
      {currentComponent === 'third' && (
        <CeramicPart uniqueIdentifier="1" /> // Pass the unique identifier here
      )}
      {currentComponent === 'Four' && (
        <Paperpart uniqueIdentifier="1" /> // Pass the unique identifier here
      )}
      {currentComponent === 'Five' && (
        <PaperBoardPart uniqueIdentifier="1" /> // Pass the unique identifier here
      )}
      {currentComponent === 'Six' && (
        <CompoundPart uniqueIdentifier="1" /> // Pass the unique identifier here
      )}
      {currentComponent === 'Seven' && (
        <GlassPart uniqueIdentifier="1" /> // Pass the unique identifier here
      )}
      {currentComponent === 'Eight' && (
        <MetalPart uniqueIdentifier="1" /> // Pass the unique identifier here
      )}
      {currentComponent === 'Nine' && (
        <MelaminePart uniqueIdentifier="1" /> // Pass the unique identifier here
      )}
      {currentComponent === 'Ten' && (
        <RubberPart uniqueIdentifier="1" /> // Pass the unique identifier here
      )}
      {currentComponent === 'Eleven' && (
        <SiliconePart uniqueIdentifier="1" /> // Pass the unique identifier here
      )}
      {currentComponent === 'Twelve' && (
        <WoodPart uniqueIdentifier="1" /> // Pass the unique identifier here
      )}
      {currentComponent === 'Thirteen' && (
        <PlasticPart uniqueIdentifier="1" /> // Pass the unique identifier here
      )}
      {currentComponent === 'Fourteen' && (
        <InkPart uniqueIdentifier="1" /> // Pass the unique identifier here
      )}
      {currentComponent === 'Fifteen' && (
        <WaxPart uniqueIdentifier="1" /> // Pass the unique identifier here
      )}
    </div>
  );
}
