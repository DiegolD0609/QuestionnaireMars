...
function CeramicPart({ uniqueIdentifier }) {
  ...
  const localStorageKey = `nameCeramic01_${uniqueIdentifier}`;
  const localStorageSelectKey1 = `subCategoryCeramic01_${uniqueIdentifier}`;
  const localStorageSelectKey2 = `fdaComplianceCeramic01_${uniqueIdentifier}`;
  const localStorageTextInputKey = `otherCategoryCeramic01_${uniqueIdentifier}`;
  const localStorageTextInputKey2 = `otherFdaCeramic01_${uniqueIdentifier}`;
  const localStorageTextInputKey4 = `gmpExplainCeramic01_${uniqueIdentifier}`;
  const localStorageTextInputKey5= `supplierNameCeramic01_${uniqueIdentifier}`;
  const localStorageRadioKey = `gmpComplianceCeramic01_${uniqueIdentifier}`;
  const localStorageResultVisible = `resultVisibleCeramic01_${uniqueIdentifier}`;  
 ...
 useEffect (() => {
  ...
  return (
    <><div className="fixed-header">
      <h1 className="header-title">Ceramic Questionnaire</h1>
