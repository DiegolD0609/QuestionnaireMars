...
function WoodPart({ uniqueIdentifier }) {
  ...
  const localStorageKey = `nameWood01_${uniqueIdentifier}`;
  const localStorageSelectKey1 = `subCategoryWood01_${uniqueIdentifier}`;
  const localStorageSelectKey2 = `fdaComplianceWood01_${uniqueIdentifier}`;
  const localStorageTextInputKey = `otherCategoryWood01_${uniqueIdentifier}`;
  const localStorageTextInputKey2 = `otherFdaWood01_${uniqueIdentifier}`;
  const localStorageTextInputKey4 = `gmpExplainWood01_${uniqueIdentifier}`;
  const localStorageTextInputKey5= `supplierNameWood01_${uniqueIdentifier}`;
  const localStorageRadioKey = `gmpComplianceWood01_${uniqueIdentifier}`;
  const localStorageResultVisible = `resultVisibleWood01_${uniqueIdentifier}`;
 ...
 useEffect (() => {
  ...
  return (
    <><div className="fixed-header">
      <h1 className="header-title">Wood Questionnaire</h1>
