...
function PlasticPart({ uniqueIdentifier }) {
  ...
  const localStorageKey = `namePlastic01_${uniqueIdentifier}`;
  const localStorageSelectKey1 = `subCategoryPlastic01_${uniqueIdentifier}`;
  const localStorageSelectKey2 = `fdaCompliancePlastic01_${uniqueIdentifier}`;
  const localStorageTextInputKey = `otherCategoryPlastic01_${uniqueIdentifier}`;
  const localStorageTextInputKey2 = `otherFdaPlastic01_${uniqueIdentifier}`;
  const localStorageTextInputKey4 = `gmpExplainPlastic01_${uniqueIdentifier}`;
  const localStorageTextInputKey5= `supplierNamePlastic01_${uniqueIdentifier}`;
  const localStorageRadioKey = `gmpCompliancePlastic01_${uniqueIdentifier}`;
  const localStorageResultVisible = `resultVisiblePlastic01_${uniqueIdentifier}`;
 ...
 useEffect (() => {
  ...
  return (
    <><div className="fixed-header">
      <h1 className="header-title">Plastic Questionnaire</h1>
        ...
        <div className="instructions">
          ...
          <label className="label">
            ...
            <select className="select" value={selectedOption1} onChange={handleSelectChange1}>
              ...
              <option value="colourant">Colourant</option>
              <option value="eVOH">EVOH</option>
              <option value="HDPE">HDPE</option>
              <option value="lDPE">LDPE</option>
              <option value="metOPP">Met OPP</option>
              <option value="metPE">Met PE</option>
              <option value="metPET">Met PET</option>
          ...
          <label className="label">
            <div className="checkbox-group">
                ...
                <label className="checkbox-label">
                    ...
                    type="checkbox"
                    value="177.1020"
                    checked={selectedOption2.includes('177.1020')}
                ...
                <label className="checkbox-label">
                    ...
                    type="checkbox"
                    value="177.1520"
                    checked={selectedOption2.includes('177.1520')}
                    onChange={handleSelectChange2} />
                    177.1520
                </label>
                <label className="checkbox-label">
                    ...
                    type="checkbox"
                    value="178.3297"
                    checked={selectedOption2.includes('178.3297')}
                    onChange={handleSelectChange2} />
                    178.3297
                </label>
                <label className="checkbox-label">
                    ...
                    type="checkbox"
                    value="177.1360"
                    checked={selectedOption2.includes('177.1360')}
                    onChange={handleSelectChange2} />
                    177.1360
                </label>
                <label className="checkbox-label">
                    ...
                    type="checkbox"
                    value="177.1630"
                    checked={selectedOption2.includes('177.1630')}
                    onChange={handleSelectChange2} />
                    177.1630
                </label>
                <label className="checkbox-label">
                    ...
                    type="checkbox"
                    value="177.2450"
                    checked={selectedOption2.includes('177.2450')}
                    onChange={handleSelectChange2} />
                    177.2450
                </label>
                <label className="checkbox-label">
                    ...
                    type="checkbox"
                    value="177.1640"
                    checked={selectedOption2.includes('177.1640')}
                    onChange={handleSelectChange2} />
                    177.1640
                </label>
              <label className="checkbox-label">
