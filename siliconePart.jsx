...
function SiliconePart({ uniqueIdentifier }) {
  ...
  const localStorageKey = `nameSilicone01_${uniqueIdentifier}`;
  const localStorageSelectKey1 = `subCategorySilicone01_${uniqueIdentifier}`;
  const localStorageSelectKey2 = `fdaComplianceSilicone01_${uniqueIdentifier}`;
  const localStorageTextInputKey = `otherCategorySilicone01_${uniqueIdentifier}`;
  const localStorageTextInputKey2 = `otherFdaSilicone01_${uniqueIdentifier}`;
  const localStorageTextInputKey4 = `gmpExplainSilicone01_${uniqueIdentifier}`;
  const localStorageTextInputKey5= `supplierNameSilicone01_${uniqueIdentifier}`;
  const localStorageRadioKey = `gmpComplianceSilicone01_${uniqueIdentifier}`;
  const localStorageResultVisible = `resultVisibleSilicone01_${uniqueIdentifier}`;
 ...
 useEffect (() => {
  ...
  return (
    <><div className="fixed-header">
      <h1 className="header-title">Silicone Questionnaire</h1>
