...
function WaxPart({ uniqueIdentifier }) {
    ...
    const localStorageKey = `nameWax01_${uniqueIdentifier}`;
    const localStorageSelectKey1 = `subCategoryWax01_${uniqueIdentifier}`;
    const localStorageSelectKey2 = `fdaComplianceWax01_${uniqueIdentifier}`;
    const localStorageTextInputKey = `otherCategoryWax01_${uniqueIdentifier}`;
    const localStorageTextInputKey2 = `otherFdaWax01_${uniqueIdentifier}`;
    const localStorageTextInputKey4 = `gmpExplainWax01_${uniqueIdentifier}`;
    const localStorageTextInputKey5= `supplierNameWax01_${uniqueIdentifier}`;
    const localStorageRadioKey = `gmpComplianceWax01_${uniqueIdentifier}`;
    const localStorageResultVisible = `resultVisibleWax01_${uniqueIdentifier}`;
   ...
   useEffect (() => {
    ...
    return (
      <><div className="fixed-header">
        <h1 className="header-title">Wax Questionnaire</h1>
          ...
          <div className="instructions">
            ...
            <label className="label">
              ...
              <select className="select" value={selectedOption1} onChange={handleSelectChange1}>
                ...
                <option value="Candelilla Wax">Candelilla Wax</option>
                <option value="Carnauba Wax">Carnauba Wax</option>
                <option value="Montan Wax">Montan Wax</option>
                <option value="Petroleum Waxes">Petroleum Waxes</option>
                <option value="Synthetic Petroleum Waxes">Synthetic Petroleum Waxes</option>
                <option value="Polyolefin Waxes">Polyolefin Waxes</option>
            ...
            <label className="label">
              ...
              <label className="checkbox-label">
                  <input
                    type="checkbox"
                    value="178.3710"
                    checked={selectedOption2.includes('178.3710')}
                ...
                <label className="checkbox-label">
                  <input
                    type="checkbox"
                    value="178.3720"
                    checked={selectedOption2.includes('178.3720')}
                    onChange={handleSelectChange2} />
                  178.3720
                </label>
                <label className="checkbox-label">
                  <input
                    type="checkbox"
                    value="178.3850"
                    checked={selectedOption2.includes('178.3850')}
                    onChange={handleSelectChange2} />
                  178.3850
                </label>
                <label className="checkbox-label">
