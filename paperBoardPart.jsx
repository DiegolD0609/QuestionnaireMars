...
function PaperBoardPart({ uniqueIdentifier }) {
    ...
    const localStorageKey = `namePaperBoard01_${uniqueIdentifier}`;
    const localStorageSelectKey1 = `subCategoryPaperBoard01_${uniqueIdentifier}`;
    const localStorageSelectKey2 = `fdaCompliancePaperBoard01_${uniqueIdentifier}`;
    const localStorageTextInputKey = `otherCategoryPaperBoard01_${uniqueIdentifier}`;
    const localStorageTextInputKey2 = `otherFdaPaperBoard01_${uniqueIdentifier}`;
    const localStorageTextInputKey4 = `gmpExplainPaperBoard01_${uniqueIdentifier}`;
    const localStorageTextInputKey5= `supplierNamePaperBoard01_${uniqueIdentifier}`;
    const localStorageRadioKey = `gmpCompliancePaperBoard01_${uniqueIdentifier}`;
    const localStorageResultVisible = `resultVisiblePaperBoard01_${uniqueIdentifier}`;
   ...
   useEffect (() => {
    ...
    return (
      <><div className="fixed-header">
        <h1 className="header-title">PaperBoard Questionnaire</h1>
            ...
            <label className="label">
              ...
              <label className="checkbox-label">
                  <input
                    type="checkbox"
                    value="176.260"
                    checked={selectedOption2.includes('176.260')}
                ...
                <label className="checkbox-label">
                  <input
                    type="checkbox"
                    value="176.170"
                    checked={selectedOption2.includes('176.170')}
                    onChange={handleSelectChange2} />
                  176.170
                </label>
                <label className="checkbox-label">
                  <input
                    type="checkbox"
                    value="176.180"
                    checked={selectedOption2.includes('176.180')}
                    onChange={handleSelectChange2} />
                  176.180
                </label>
                <label className="checkbox-label">
