...
function MelaminePart({ uniqueIdentifier }) {
  ...
  const localStorageKey = `nameMelamine01_${uniqueIdentifier}`;
  const localStorageSelectKey1 = `subCategoryMelamine01_${uniqueIdentifier}`;
  const localStorageSelectKey2 = `fdaComplianceMelamine01_${uniqueIdentifier}`;
  const localStorageTextInputKey = `otherCategoryMelamine01_${uniqueIdentifier}`;
  const localStorageTextInputKey2 = `otherFdaMelamine01_${uniqueIdentifier}`;
  const localStorageTextInputKey4 = `gmpExplainMelamine01_${uniqueIdentifier}`;
  const localStorageTextInputKey5= `supplierNameMelamine01_${uniqueIdentifier}`;
  const localStorageRadioKey = `gmpComplianceMelamine01_${uniqueIdentifier}`;
  const localStorageResultVisible = `resultVisibleMelamine01_${uniqueIdentifier}`;
 ...
 useEffect (() => {
  ...
  return (
    <><div className="fixed-header">
      <h1 className="header-title">Melamine Questionnaire</h1>
